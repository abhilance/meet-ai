...
const DisabledVideoPreview=()=>{
    ...
    return (
        ...
        participant={
            {
                name: data.user.name?? "",
                image: data.user.image?? genetratedAvatarUri({seed:data.user.name?? "", variant:"initials"})
...
const AllowBrowserPermission= ()=>{
    return (
        <p className="text-sm">Please grant browser to access your camera and microphone</p>
    )
}
